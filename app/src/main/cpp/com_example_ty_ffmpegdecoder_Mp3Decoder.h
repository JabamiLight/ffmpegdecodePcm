...
#include <jni.h>
/* Header for class com_example_ty_ffmpegdecoder_Mp3Decoder */

#ifndef _Included_com_example_ty_ffmpegdecoder_Mp3Decoder
#define _Included_com_example_ty_ffmpegdecoder_Mp3Decoder
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_example_ty_ffmpegdecoder_Mp3Decoder
 * Method:    Init
